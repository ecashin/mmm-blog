...
BLOG_AUTHOR = "Ed Cashin"  # (translatable)
BLOG_TITLE = "Mostly Mediocre Miscellany 2"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://noserose.net/mmm-blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://noserose.net/mmm-blog/"
BLOG_EMAIL = "ed.cashin@acm.org"
BLOG_DESCRIPTION = "Technical meanderings"  # (translatable)
